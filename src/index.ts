...
const main = (): void => {
  const opcion: number = 3; // <-- Cambia este número (1..5) para probar
  switch (opcion) {
    case 1:
      listarLugares();
      break;
    case 2:
      const nombreBuscado: string = "Sabio"; // <-- Cambia el nombre para probar
...
main();
const opcion: number = 1; // Cambia entre 1,2,3,4,5

/*
1	Lista los lugares y su nivel de peligro
2	Busca un personaje por nombre (ej. "Sabio")
3	Muestra inventario con frases (ya lo probaste)
